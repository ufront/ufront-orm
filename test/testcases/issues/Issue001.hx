...
class Issue001 extends DBTestClass {
	...
	override function setup() {
		super.setup();
		createTable( Issue001_MyObject );
		createTable( Issue001_Category );
		createTable( Issue001_Language );
		createJoinTable( Issue001_MyObject, Issue001_Category );
		createJoinTable( Issue001_MyObject, Issue001_Language );
