...
class Object #if server extends sys.db.Object #end {
	...
	**/
	...
	function set_hxSerializationFields( fields:Array<String> ):Array<String> {
		return hxSerializationFields = fields;
	}
	...
	**/
	public function hxSerialize( s:haxe.Serializer ) {
		s.useEnumIndex = true;
		s.useCache = false;
		s.serialize( hxSerializationFields.join(",") );
		for ( f in hxSerializationFields ) {
	...
	**/
	public function hxUnserialize( s:haxe.Unserializer ) {
		var hxSerializationFieldsString:String = s.unserialize();
		hxSerializationFields = hxSerializationFieldsString.split(",");
		for ( f in hxSerializationFields ) {
